...
func (m *RedisConn) Reset()         { *m = RedisConn{} }
func (m *RedisConn) String() string { return proto.CompactTextString(m) }
func (*RedisConn) ProtoMessage()    {}
func (*RedisConn) Descriptor() ([]byte, []int) {
	return fileDescriptor_d954120a2319ff8f, []int{0}
}

func (m *RedisConn) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RedisConn.Unmarshal(m, b)
}
func (m *RedisConn) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RedisConn.Marshal(b, m, deterministic)
}
func (m *RedisConn) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RedisConn.Merge(m, src)
}
func (m *RedisConn) XXX_Size() int {
	return xxx_messageInfo_RedisConn.Size(m)
}
func (m *RedisConn) XXX_DiscardUnknown() {
	xxx_messageInfo_RedisConn.DiscardUnknown(m)
}

var xxx_messageInfo_RedisConn proto.InternalMessageInfo
...
func (m *SisMemberRequest) GetUrl() []byte {
	if m != nil {
		return m.Url
	}
	return nil
...
type SadDRequest struct {
	CrawledURL           []byte   `protobuf:"bytes,1,opt,name=crawledURL,proto3" json:"crawledURL,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SadDRequest) GetCrawledURL() []byte {
	if m != nil {
		return m.CrawledURL
	}
	return nil
...
func init() {
	proto.RegisterType((*RedisConn)(nil), "redis.RedisConn")
	proto.RegisterType((*PushQueueRequest)(nil), "redis.PushQueueRequest")
	proto.RegisterType((*PopQueueReply)(nil), "redis.PopQueueReply")
	proto.RegisterType((*RangeQueueReply)(nil), "redis.RangeQueueReply")
	proto.RegisterType((*SisMemberRequest)(nil), "redis.SisMemberRequest")
	proto.RegisterType((*SisMemberReply)(nil), "redis.SisMemberReply")
	proto.RegisterType((*SadDRequest)(nil), "redis.SadDRequest")
}
...
var fileDescriptor_d954120a2319ff8f = []byte{
	...
	,
}
...
type DBServiceClient interface {
	//    rpc GetRedisConn (google.protobuf.Empty) returns (RedisConn){};
...
func (c *dBServiceClient) PushQueue(ctx context.Context, in *PushQueueRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/redis.DBService/PushQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) PopQueue(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PopQueueReply, error) {
	...
	err := c.cc.Invoke(ctx, "/redis.DBService/PopQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) RangeQueue(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*RangeQueueReply, error) {
	...
	err := c.cc.Invoke(ctx, "/redis.DBService/RangeQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) SisMember(ctx context.Context, in *SisMemberRequest, opts ...grpc.CallOption) (*SisMemberReply, error) {
	...
	err := c.cc.Invoke(ctx, "/redis.DBService/SisMember", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) SadD(ctx context.Context, in *SadDRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/redis.DBService/SadD", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DBService_PushQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/redis.DBService/PushQueue",
	}
...
func _DBService_PopQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/redis.DBService/PopQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DBService_RangeQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/redis.DBService/RangeQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DBService_SisMember_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/redis.DBService/SisMember",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DBService_SadD_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/redis.DBService/SadD",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
